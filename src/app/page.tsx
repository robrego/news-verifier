        ...
        <header className="mb-12 sm:mb-20 flex justify-between items-center">
          ...
          {/* Right: Nav + Mini Switch */}
           ...
           <nav className="flex gap-8">
            <Link href="/" className={`text-[10px] uppercase tracking-[0.2em] font-bold transition-all ${isDark ? 'text-white' : 'text-blue-600'}`}>
             News
            </Link>
             <Link href="/video" className={`text-[10px] uppercase tracking-[0.2em] font-bold transition-all ${isDark ? 'text-slate-600 hover:text-slate-400' : 'text-slate-300 hover:text-slate-500'}`}>
             Videos
        </Link>
        </nav>
